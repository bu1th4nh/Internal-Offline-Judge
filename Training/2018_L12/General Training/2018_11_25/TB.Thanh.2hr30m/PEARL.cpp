...
//=====================================
//Constants
const long long sqrn[10] = {0, 1, 4, 9, 16, 25, 36, 49, 64, 81};
...
void Preps()
{
    really_nigga = vb(9999, 0);
    FOR(i, 1, 1539) really_nigga[i] = gprs(i);
}
bool check(ll x)
{
    int tmp = 0;
