...
/*
        1. Problem Briefing
            Given a tree with n vertices and an integer k. Find all pairs of
            vertices (u, v) such that |u - v| <= k.
        2. Keyword: tree, data-structures
        3. Solution: Using GNU-PBDS to count the number of vertices which satisfy
...
void DFS(int u)
{
    res += ctb.order_of_key(u+k+1) - ctb.order_of_key(u-k);
