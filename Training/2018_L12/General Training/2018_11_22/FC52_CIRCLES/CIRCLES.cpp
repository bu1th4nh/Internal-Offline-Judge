...
//=====================================
//Constants
const long double M_PI = acos(-1.00000000000000);
...
long double res, p, r, a, b, c, lambda, circles;
int L1, L2;
...
int main()
{
    ...
    b = 1.00000000 * L1;
    c = 1.00000000 * L2;
    a = 1.00000000 * hypot(b, c);

    r = (b * c) / (a + b + c);
    p = r + hypot(r, (r - b));
    lambda = 1.000000 - 2.0000000 * r / p;

    circles = M_PI * sqr(r) / (1.00000000 - sqr(lambda));
    res = circles / (b * c / 2.000000000000000000000000);
