...
/*
        Brief: Check if given graph is isomorphism w/ sample graph

        Solution:   * Generate 4! = 24 permutations and re-indexing the graph
                    (because of there must have exact 4 2-degree vertex to form
                     needed graph)
